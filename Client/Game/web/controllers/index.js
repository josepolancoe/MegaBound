...
router.get('/ri', function (req, res) {
    res.setHeader('Content-Type', 'application/json');
    var level = [1484523031262, 
        [1100, 1200, 1500, 1800, 2300, 2800, 3500, 4200, 5100, 6000,
             6900, 10042, 15001, 22933, 30000, 40000, 50000, 60000,
             70000, 80000, 90000, 100000, 110000, 120000],
        ["?", "?", "?", "?", "?", 135302, 135077, 163494, 114707, 78796, 58187,
         149628, 134666, 119702, 104740, 89776, 59852, 44888, 22444,
          14963, 6733, 748, 16, 4, 1, 0, 0, 0, 0, 0, 0, 0],
...
router.get('/w2', function (req, res) {
    req.db.setUpdateRank();
    res.setHeader('Content-Type', 'application/json');
    // var data = [86, 0, 0, ["High Ranks",0,9001,45,3000,9,24],["Mid Ranks",0,9002,511,3000,7,17],["Beginners",0,9003,970,5000,0,6],
    // ["All",0,9004,711,3000],["All",0,9005,1658,3000],["Bunge.",1,9006,352,3000],["All",0,9007,349,3000],["All",0,9008,379,3000],
    // ["Aduka.",1,9009,210,3000],["All",0,9010,173,3000],["All",0,9011,193,3000],
    // ["Dragon OFF",2,9012,10,4000,11,24,1586995140000,1587002340000],
